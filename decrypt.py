...
if __name__ == "__main__":
    ...
    test_y, test_x = generate_data(1 << 14)

    if False:
        print("Generating training data..")
        train_y, train_x = generate_data(1 << 16)
        print("Encrypted:{} ; Decrypted:{} ".format(train_x[0], train_y[0]))

        train_model(train_x, train_y, test_x, test_y)

    y_pred = test_model(test_x, test_y)
    print("Evaluating score based on given criterion..")
    print(score(y_pred, test_y))
